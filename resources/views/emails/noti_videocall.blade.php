...
<body>
    ...
    <div class="container" >
      <div><header style="background-color: #007BFF; /* สีพื้นหลังของ Header */
            ...
            width: 93%;
            border-radius: 10px;"><h1 class="big">ยืนยันการนัดหมาย Video Call</h1></header></div>
        <p style="text-align: left; font-size: 18px;">เรียน คุณ{{$firstname}}  {{$lastname}}</p>

        <p style="text-align: center; font-size: 25px; font-color: black"><strong>การนัดหมายของคุณยืนยันแล้ว</strong></p>
        ...
        <ul>
            ...
            <li style="font-size: 16px;">เวลาที่นัดหมาย: {{$time_start}} - {{$time_end}}</li>
            <li style="font-size: 16px;">รายละเอียด: {{$reason}}</li>
            <li style="font-size: 18px;">ลิงค์สำหรับการเข้าร่วมการสนทนา: <a href="https://meet.google.com/neo-fgpi-znu">https://meet.google.com/neo-fgpi-znu</a></li>
